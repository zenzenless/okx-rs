...
pub struct ApiV5AccountSetGreeksPostRequest {
    /// 希腊字母展示方式<br>`PA`：币本位，`BS`：美元本位
    #[serde(rename = "greeksType")]
    pub greeks_type: String,
}

impl ApiV5AccountSetGreeksPostRequest {
    pub fn new(greeks_type: String) -> ApiV5AccountSetGreeksPostRequest {
        ApiV5AccountSetGreeksPostRequest {
            greeks_type,
        }
    }
}
