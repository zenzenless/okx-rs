...
use account::apis::configuration::NewConf;
use base64::encode;
use chrono::Utc;
use hmac::{Hmac, Mac};
...
impl NewConf for Configuration {
    fn new(base_path:impl Into<String>,api_key:impl Into<String>,secret_key:impl Into<String>,passphrase :impl Into<String>) -> Configuration {
